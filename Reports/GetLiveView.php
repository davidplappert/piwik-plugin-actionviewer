...
namespace Piwik\Plugins\ActionViewer\Reports;
 ...
 */
class GetLiveView extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('ActionViewer_LiveView');
        //$this->dimension     = new EventName();
        $this->documentation = Piwik::translate('A live list of the latest events.');
        ...
        // $this->widgetTitle  = 'ActionViewer_LiveView';
    }
    ...
    {
        $view = new View('@ActionViewer/getLiveView');
        $view->myData = array();
